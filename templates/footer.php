    ...
    <footer class="footer d-flex flex-wrap justify-content-between align-items-center border-top">
        ...
        <div class="col-md-4 d-flex flex-column justify-content-center">
            <ul class="d-flex flex-column text-center list-unstyled">
                <li class="fs-5 fw-5">Informations légales</li>
                <li><a href="politiqueconf.php">Politique de confidentialité</a></li>
                <li><a href="mentions_legales.php">Mentions légales</a></li>
            </ul>
        </div>

        <div class="col-md-4 d-flex align-items-center justify-content-center mb-3 mb-md-0 me-md-auto link-body-emphasis">
            <ul class="d-flex flex-column text-center list-unstyled text-white">
                <li class="fs-5 fw-5">WillRunExpert</li>
